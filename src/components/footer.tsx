import { P2 } from "./layout/paragraphs";
...
export const Footer = () => {
  return (
    <footer className="max-w-container site:px-0 mx-auto mt-auto grid w-full gap-6 px-4 pt-8 pb-5 max-md:place-items-center md:grid-flow-col md:justify-between md:px-10 md:py-8 lg:px-15">
      <div className="flex items-center gap-6 md:order-2">
        <InstaIcon />
        <TiktokIcon />
        <BlueskyIcon />
      </div>
      <P2>Made with ❤️ and 🥑</P2>
    </footer>
  );
};
